...
export default function registerPage({
    ...
    if (!fontsLoaded) {
        ...
        return ( <
            ...
            style = {
                classes.back_btn_cont
            } >
            <
            Text style = {
                classes.back_btn_txt
            } > < /Text> <
