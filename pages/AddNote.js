...
export default function AddNote({ route, navigation }) {
    ...
    return (
        <View>
            ...
            <Button title="press to add note" onPress={async() => {await route.params.addingNote(
                { created: new Date(), fam_ID: 'cohen222', title: title, text: text, username: 'david22',status:'1' }
            )
